...
const headline =
  "Scaling infrastructure. Sustaining the planet. Shipping software.";
const words = headline.split(" ");

export default function Hero() {
  return (
    // FIXED: Changed px-1 to px-6 to give proper spacing on mobile screens. 
    // Kept md:px-8 for larger screens to maintain the layout.
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden px-6 pt-32 pb-32 md:px-8 lg:pb-40">
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex flex-col items-center justify-between gap-16 lg:flex-row lg:gap-32">
          ...
          <div className="w-full flex-1 max-w-3xl z-10">
            ...
            >
              I&rsquo;m{" "}
              <span className="font-semibold text-ink">{profile.name}</span>. As
              the founder of GranoInfra, GreenWorld, and Moyo International, my
              work spans heavy infrastructure, sustainability, and consumer
              software. I spend my days turning massive, unglamorous problems
              into simple, inevitable solutions.
            </motion.p>
          ...
          >
            ...
            <div className="relative z-10 overflow-hidden aspect-square rounded-full border border-stone-100 bg-white p-2 shadow-2xl shadow-stone-200/50">
              <img
